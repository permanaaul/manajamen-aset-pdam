    ...
    try {
      ...
      data = await prisma.hblWorkOrder.findUnique({
        ...
        select: {
          ...
          targetTanggal: true,
          selesaiTanggal: true,
          jenisPekerjaan: true,       // bisa belum ada
          biayaMaterialRp: true,      // bisa belum ada
          biayaJasaRp: true,          // bisa belum ada
...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    if ("targetTanggal" in body) {
      allowed.targetTanggal = body.targetTanggal ? new Date(String(body.targetTanggal)) : null;
    }
    if ("tipe" in body) {
